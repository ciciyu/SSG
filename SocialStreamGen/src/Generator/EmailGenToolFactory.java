 ...
 */
public class EmailGenToolFactory extends AbstractSSSGenTool {
	...
	public Long nextTime(Item item) throws ParseException {
		// TODO Auto-generated method stub
//		if (Math.random() < 0.5) {
//			if(item.getTime()<Parameter.endTime){
//				int upbound = (int) (item.getTime() + 3600*24);
//				if (upbound > Parameter.endTime) {
//					upbound = Parameter.endTime.intValue();
//				}
//				UniformIntegerGenerator gen = new UniformIntegerGenerator(item.getTime().intValue(),
//						upbound);
...
//		}
	...
	// long interval = para.getLinkIntervalsGen().nextValue(timeInterval);
	// if (timeInterval >= gap) {
	// long min_intervals = item.getTime() - interval -
	// para.getLinkIntervalsGen()
	// .getLinkGranularity();
