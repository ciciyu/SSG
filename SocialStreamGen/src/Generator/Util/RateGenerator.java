...
//	DiscreteGenerator<String> exponentGen = new DiscreteGenerator<String>();
	...
	public RateGenerator(String discretePath) throws Exception{
		range= new TimeUtil("1999-12-28").getSeconds()-new TimeUtil("1969-01-07").getSeconds();
//		range =TimeUtil.changePatentTimeToSeconds("1999-12-28") - TimeUtil
//		.changePatentTimeToSeconds("1969-01-07");
